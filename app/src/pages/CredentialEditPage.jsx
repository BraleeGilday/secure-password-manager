...
import { fetchCredentialById, updateCredential } from "../api/credentials";

import PasswordGeneratorButton from "./pwd_gen/PasswordGeneratorButton";

export default function CredentialEditPage({ onLogout }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      ...
      window.alert(
        "Please enter a Site, Username, and Password to edit a credential."
      );
      return;
    }

    const response = await updateCredential(id, formData);
    ...
    <div className="vault-page">
      ...
      <div className="vault-layout">
        ...
        <section className="vault-content">
          <div className="card">
            <h3 style={{ marginTop: 0 }}>Replace Fields with Desired Changes</h3>
